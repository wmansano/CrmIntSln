...
namespace CrmScan.intws {
    ...
    public partial class Events : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Events() {
            this.Url = global::CrmScan.Properties.Settings.Default.LC_CHECKIN_intws_events;
        ...
        /// <remarks/>
        public void SaveEventRegistrationAsync(string Token, EventRegistration eventRegistrationObj) {
            this.SaveEventRegistrationAsync(Token, eventRegistrationObj, null);
        }
        
        /// <remarks/>
        public void SaveEventRegistrationAsync(string Token, EventRegistration eventRegistrationObj, object userState) {
