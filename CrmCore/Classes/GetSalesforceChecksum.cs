...
namespace CrmCore
{
    public partial class CrmCoreLogic : IDisposable
    {
        ...
        //private bool CleanupSalesforceRecords()
        //{
        ...
        //        //TotalResults(result, GetAccountChecksum(GetSoqlString(SoqlEnums.DownloadAccountChecksum, GetLastRunDateTime(LastModified.Account))));
        //        //TotalResults(result, GetContactChecksum(GetSoqlString(SoqlEnums.DownloadContactChecksum, GetLastRunDateTime(LastModified.Contact))));
        //        //TotalResults(result, GetAffiliationChecksum(GetSoqlString(SoqlEnums.DownloadAffiliationChecksum, GetLastRunDateTime(LastModified.Affiliation))));
        //        //TotalResults(result, GetApplicationChecksum(GetSoqlString(SoqlEnums.DownloadApplicationChecksum, GetLastRunDateTime(LastModified.Application))));
        //        //TotalResults(result, GetInquiryChecksum(GetSoqlString(SoqlEnums.DownloadInquiryChecksum, GetLastRunDateTime(LastModified.Inquiry))));
        //        //TotalResults(result, GetTaskChecksum(GetSoqlString(SoqlEnums.DownloadTaskChecksum, GetLastRunDateTime(LastModified.Task))));
        //        //TotalResults(result, GetEventChecksum(GetSoqlString(SoqlEnums.DownloadEventChecksum, GetLastRunDateTime(LastModified.Event))));
        //        //TotalResults(result, GetActivityExtenderChecksum(GetSoqlString(SoqlEnums.DownloadActivityExtenderChecksum, GetLastRunDateTime(LastModified.ActivityExtender))));
        //        //TotalResults(result, GetEventRegistrationChecksum(GetSoqlString(SoqlEnums.DownloadEventRegistrationChecksum, GetLastRunDateTime(LastModified.EventRegistration))));
        //        //TotalResults(result, GetEmailBroadcastChecksum(GetSoqlString(SoqlEnums.DownloadEmailBroadcastChecksum, GetLastRunDateTime(LastModified.EmailBroadcast))));
        //        //TotalResults(result, GetEmailCampaignChecksum(GetSoqlString(SoqlEnums.DownloadEmailCampaignChecksum, GetLastRunDateTime(LastModified.EmailCampaign))));
        //        //TotalResults(result, GetEmailTemplateChecksum(GetSoqlString(SoqlEnums.DownloadEmailTemplateChecksum, GetLastRunDateTime(LastModified.EmailTemplate))));
        //        //TotalResults(result, GetTermChecksum(GetSoqlString(SoqlEnums.DownloadTermChecksum, GetLastRunDateTime(LastModified.Term))));
        //        //TotalResults(result, GetProgramChecksum(GetSoqlString(SoqlEnums.DownloadProgramChecksum, GetLastRunDateTime(LastModified.Program))));
        //        //TotalResults(result, GetCourseChecksum(GetSoqlString(SoqlEnums.DownloadCourseChecksum, GetLastRunDateTime(LastModified.Course))));
        //        //TotalResults(result, GetCourseOfferingChecksum(GetSoqlString(SoqlEnums.DownloadCourseOfferingChecksum, GetLastRunDateTime(LastModified.CourseOffering))));
        //        //TotalResults(result, GetCourseConnectionChecksum(GetSoqlString(SoqlEnums.DownloadCourseConnectionChecksum, GetLastRunDateTime(LastModified.CourseConnection))));
        //        //TotalResults(result, GetReportChecksum(GetSoqlString(SoqlEnums.DownloadReportChecksum, GetLastRunDateTime(LastModified.Report))));
        //        //TotalResults(result, GetRoleValueChecksum(GetSoqlString(SoqlEnums.DownloadRoleValueChecksum, GetLastRunDateTime(LastModified.RoleValue))));
        //        //TotalResults(result, GetProgramEnrollmentChecksum(GetSoqlString(SoqlEnums.DownloadProgramEnrollmentChecksum, GetLastRunDateTime(LastModified.ProgramEnrollment))));
        ...
        //    RecordTransaction(MethodName, StartTime, result.TotalCount, result.InsertedCount, result.UpdatedCount, ErrorMsg);

        //    return success;

        //}

        //private Result CleanUpAccountRecords(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        //    List<Account> all_sf_records = new List<Account>();
        //    List<crm_accounts> local_accounts = new List<crm_accounts>();
        ...
        //        {
        //            all_sf_records = api.Query<Account>(soql);
        //        }

        //        var all_db_records = db_ctx.crm_accounts.Where(x => x.account_deleted == false
        //                                                    && x.account_mark_delete == false)
        //                                             .ToDictionary(x => x.account_id, x => x.account_modifed_datetime);

        //        var unique_db_records = all_db_records.GroupBy(x => x.Key).Where(g => g.Count() == 1);
        //        var unique_sf_records = all_sf_records.GroupBy(x => x.Id).Where(g => g.Count() == 1);

        //        //update_accounts = all_sf_records.Distinct().Where(x => !unique_db_records.Any(y => y.Key == x.Id)
        //        //                                                || (unique_db_records.Any(y => (y.Key == x.Id
        //        //                                                                        && y.V.AddHours(-7) != x.LastModifiedDate)))).ToList();


        //        //result.TotalCount = update_accounts.Count;
        //        //if (MonitorExecution(MethodName, result.TotalCount))
        //        //{
        //        //    foreach (Account update_account in update_accounts)
        //        //    {
        //        //        result = SaveAccount(result, update_account);
        //        //    }
        //        //}
        //    }
        //    catch (Exception ex)
        ...
        //private Result GetApplicationChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfApplications.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetContactChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfContacts.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        //            foreach (Contact SfContact in SfContacts)
        //            {
        //                result = SaveContact(result, SfContact);
        //            }
        //        }
        //    }
        //    catch (Exception ex)
        ...
        //private Result GetTermChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfTerms.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetCourseChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = sf_courses.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetCourseOfferingChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfCourseOfferings.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetCourseConnectionChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = sf_course_enrollments.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetProgramChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfAccounts.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        //            foreach (Account SfAccount in SfAccounts)
        //            {
        //                result = SaveProgram(result, SfAccount);
        //            }
        //        }
        //    }
        //    catch (Exception ex)
        ...
        //private Result GetProgramEnrollmentChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfProgram_enrollments.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetAffiliationChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfAffiliations.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        //            foreach (hed__Affiliation__c SfAffiliation in SfAffiliations)
        //            {
        //                result = SaveAffiliation(result, SfAffiliation);
        //            }
        //        }
        //    }
        //    catch (Exception ex)
        ...
        //private Result GetInquiryChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = sf_inquiries.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetTaskChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = sf_tasks.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetEventChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfEvents.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetActivityExtenderChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //private Result GetEventRegistrationChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfEvent_registrations.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetEmailCampaignChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //private Result GetEmailBroadcastChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = sf_email_broadcasts.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetEmailTemplateChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //private Result GetReportChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfReports.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        //private Result GetRoleValueChecksum(string soql)
        //{
        //    Result result = new Result();
        //    string MethodName = string.Empty;
        //    DateTime StartTime = DateTime.Now;
        ...
        //        result.TotalCount = SfRoleValues.Count;
        //        if (MonitorExecution(MethodName, result.TotalCount))
        //        {
        ...
        #region Mark Delete CrmDb Duplicates
        //private bool CleanupDuplicateDbAccounts()
        //{
        //    int total = 0;
        //    int updated = 0;
        //    int inserted = 0;
        ...
        //        var duplicates = db_ctx.crm_accounts.Where(x => x.account_deleted == false
        //                                                && x.account_mark_delete == false)
        //                                            .OrderByDescending(b=>b.account_modifed_datetime)
        //                                            .GroupBy(x => x.account_colleague_id)
        //                                            .Where(g => g.Count() > 1);
        //        total = duplicates.Count();

        //        if (duplicates.Any())
        //        {
        //            foreach (crm_accounts duplicate in duplicates) {
        //                duplicate.account_mark_delete = true;
        //                duplicate.account_modifed_datetime = DateTime.Now;
        //                updated++;
        //            }
        //        }
        ...
        #endregion Delete CrmDb Duplicates
    }
}
