...
namespace CrmCore
{
    public class FTP
    {
        ...
        /* Construct Object */
        private FTP(string hostIP, string userName, string password) { host = hostIP; user = userName; pass = password; }
        ...
        /* Rename File */
        private void rename(string currentFileNameAndPath, string newFileName)
        {
            try
            {
                /* Create an FTP Request */
        ...
        private string getFileCreatedDateTime(string fileName)
        {
            try
            {
                /* Create an FTP Request */
        ...
        private string[] directoryListSimple(string directory)
        {
            try
            {
                /* Create an FTP Request */
