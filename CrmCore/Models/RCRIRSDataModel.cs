...
namespace CrmCore.Models
{
    public class RCRIRSDataModel
    {
        ...
        public bool SetOptions()
        {
            ...
            if (TermOptions == null || ProgramOptions == null)
            {
        ...
        public static bool LookupContact()
        {
            bool success = false;
        ...
        [Display(Name = "I am interested in:")]
        public bool EnableSfadCtInterest { get; set; }
